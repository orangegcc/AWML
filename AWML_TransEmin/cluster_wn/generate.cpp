...
int main(int argc, char** argv)
{
    ...
    FILE* f1 = fopen("../data/wn/original/entity2id.txt","r");
	FILE* f2 = fopen("../data/wn/original/relation2id.txt","r");
	int x;
    ...
    FILE* f_kb = fopen("/home/minelab/guochenchen/data_WN18/wordnet-mlj12-train.txt","r");
