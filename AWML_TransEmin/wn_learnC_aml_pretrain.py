...
import energy.sparse.learning_adaden as learning
...
def learn(state):
    ...
    with open('./wn_margin/wn_TransC_ap/best_valid_model.pkl','rb') as f:
    ...
    f = open('wn_density_rel_C.pkl','rb')
    dens = pickle.load(f)
    f.close()
    ...
    with open('./wn_subrel2rel_apC.pkl','rb') as f:
        subrel2rel = pickle.load(f)
    with open('./wn_rel2subrel_apC.pkl','rb') as g:
