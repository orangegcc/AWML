...
def main(argv):
    ...
    idx2entity_C_path = 'original/WN_idx2synset_C.pkl'

    train_lhs_path = 'original/WN-train-inpl_C.pkl'
    train_rel_path = 'original/WN-train-inpo_C.pkl'
    train_rhs_path = 'original/WN-train-inpr_C.pkl'
    ...
    '''
    train_f = open('WN-train_C.pkl', 'wb')
