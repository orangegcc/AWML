...
def TrainFn1Member(fnsim, embeddings, density, marw, marb, leftop, rightop, rel=True,
    ...
    costl, outl = loss(simi*margl, similn*(1-margl), margin=loss_margin)
    costr, outr = loss(simi*margr, simirn*(1-margr), margin=loss_margin)
    ...
    if rel:
        ...
        costo, outo = loss(simi*margr, simion*(1-margr), margin=loss_margin)
        cost += costo
