...
def RankingEval(datapath='../data_FB15k/', dataset='FB15k-test',
    ...
    # Positives
    trainl = load_file(datapath + 'FB15k-train-inpl_RC.pkl')
    trainr = load_file(datapath + 'FB15k-train-inpr_RC.pkl')
    traino = load_file(datapath + 'FB15k-train-inpo_RC.pkl')
    traino = traino[-2467:, :]
    ...
    res = FilteredRankingScoreIdx_test(ranklfunc, rankrfunc, idxtl, idxtr, idxto, true_triples, rel2subrel)
    dres = {}
