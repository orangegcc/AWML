...
def FB15kexp(state, channel):
    ...
    os.mkdir('./FB15k_TransRC_ap_adaden1/embedding/')
    state.bestvalid = -1
    ...
    for epoch_count in xrange(1, state.totepochs + 1):
        ...
        if (epoch_count % 50) == 0:
            p = open('./FB15k_TransRC_ap_adaden1/embedding/'+str(epoch_count)+'.pkl','w')
...
def launch(datapath='data/', dataset='FB15k', Nent=17418, rhoE=1, rhoL=5,
        ...
        nbatches=100, totepochs=2000, test_all=1, neval=50, seed=123, pretrain='True'
