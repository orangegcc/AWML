...
f = open('../data_FB15k/FB15k-train-lhs.pkl','r')
g = open('../data_FB15k/FB15k-train-rhs.pkl','r')
h = open('../data_FB15k/FB15k-train-rel.pkl','r')
...
f.close()
g = open('../data_FB15k/FB15k_idx2entity.pkl','r')
...
f = open('../data_FB15k/FB15k-train-inpl_C.pkl','w')
g = open('../data_FB15k/FB15k-train-inpr_C.pkl','w')
h = open('../data_FB15k/FB15k-train-inpo_C.pkl','w')
