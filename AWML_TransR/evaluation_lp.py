...
def RankingEval(datapath='../data_FB15k/', dataset='FB15k-test',
    ...
    # Positives
    trainl = load_file(datapath + 'FB15k-train-lhs.pkl')
    trainr = load_file(datapath + 'FB15k-train-rhs.pkl')
    traino = load_file(datapath + 'FB15k-train-rel.pkl')
    traino = traino[-1345:, :]
    ...
    # pdb.set_trace()
    res = FilteredRankingScoreIdx(ranklfunc, rankrfunc, idxtl, idxtr, idxto, true_triples)
    dres = {}
