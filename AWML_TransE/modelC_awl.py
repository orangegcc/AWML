...
def TrainFn1Member(fnsim, embeddings, density, marw, marb, leftop, rightop, beta=24.5, marge=1.0, rel=True):
    ...
    costr, outr = margincost(simi*margr, simirn*(1-margr), marge)
    cost = costl + costr
    ...
    if rel:
        ...
        costol, outol = margincost(simi*margl, simion*(1-margl), marge)
        costor, outor = margincost(simi*margr, simion*(1-margr), marge)
