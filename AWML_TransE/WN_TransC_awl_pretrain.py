...
launch(op='TransE', dataset='WN', simfn='L1', ndim=20, nhid=20, marge=2., lremb=0.01, lrparam=1.,
    nbatches=100, totepochs=5000, test_all=10, neval=1000, savepath='WN_TransC_awl_pretrain',
    datapath='../data_WN18/', Nent=40991,  Nsyn=40943, Nrel=48, pretrain='True')
t2 = time()
